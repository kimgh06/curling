...
char title[50][60];
char name1[6], name2[6], oname[6] = {""};
int on = 0, locat = 4, up = 0, dtc = 0, speed = 0, gn, twink = 250;
short b1 = 5, b2 = 5, p1 = 0, p2 = 0, bx = 29, by, turn = 0, LR = 1, player = 0, used = 0, sure = 0; // 10 미만
double st; //시작 시간
